...
function GuardarExamen(Nombre) {
    ...
    axios({
        method: 'post',
        url: 'https://accesibilidad-proyecto-jcm.herokuapp.com/Escribirtxt',
        data: formData,
...
function actualizarplantilla() {
    var plantillapregunta = '<div id="' + NoPreguntas + '" class="media tm-media"><div class="media-body tm-box-5"><h2>¿Cual es la Pregunta?</h2><textarea name="txtPregunta' + NoPreguntas + '" id="txtPregunta' + NoPreguntas + '" cols="30" rows="2"' +
        'placeholder="Pregunta sin titulo"></textarea>  <input type="file" name="FPregunta' + NoPreguntas + '" id="FPregunta' + NoPreguntas + '" accept="video/*"><br><ul><li><input type="radio" name="RadioAbierta' + NoPreguntas + '" id="RadioAbierta' + NoPreguntas + '" onclick="PreguntaAbierta(' + NoPreguntas + ')"> <label for=RadioAbierta' + NoPreguntas + '> Opcion Pregunta Abierta </label></li>' +
        '<li><input type="radio" name="RadioCerrada' + NoPreguntas + '" id="RadioCerrada' + NoPreguntas + '" onclick="PreguntaCerrada(' + NoPreguntas + ')"><label for=RadioCerrada' + NoPreguntas + '> Opcion Pregunta Cerrada </label></li></ul><div id="TiposPreguntas' + NoPreguntas + '">' +
...
function AgregarCerradas(num) {
    var preguntasCerradas = '<div id="ElemntosPreguntas' + num + '" class="ElementosPreguntasCerradas"><ul><li><h3>Respuesta Correcta:</h3></li><li><textarea name="RespuestaCorrecta-' + num + '" id="RespuestaCorrecta-' + num + '" cols="30" rows="2" ' +
        'placeholder="Escriba la Respuesta Correcta"></textarea> <input type="file" name="FRespuestaC' + num + '" id="FRespuestaC' + num + '" accept="video/*"></li></ul><br><ul><li><h3>Opcion 1:</h3></li><li><textarea name="Respuesta1-' + num + '" id="Respuesta1-' + num + '" cols="30" rows="2"' +
        'placeholder="Escriba la opcion 1"></textarea></li></ul><ul><li><input type="file" name="FRespuesta1-' + num + '" id="FRespuesta1-' + num + '" accept="video/*"> </li></ul><ul><li><h3>Opcion 2:</h3>' +
        '</li><li><textarea name="Respuesta2-' + num + '" id="Respuesta2-' + num + '" cols="30" rows="2"placeholder="Escriba la opcion 2"></textarea></li></ul><ul><li><input type="file" name="FRespuesta2-' + num + '" id="FRespuesta2-' + num + '" accept="video/*"> ' +
        '</ul><ul><li><h3>Opcion 3:</h3></li><li><textarea name="Respuesta3-' + num + '" id="Respuesta3-' + num + '" cols="30" rows="2"placeholder="Escriba la opcion 3"></textarea>' +
        ...
        'placeholder="Escriba la opcion 4"></textarea></li></ul><ul><li> <input type="file" name="FRespuesta4-' + num + '" id="FRespuesta4-' + num + '" accept="video/*"> </li></ul></div>';
...
function AgregarAbierta(num) {
    var preguntaAbierta = '<div id="ElemntosPreguntas' + num + '" class="ElementosPreguntasAbiertas"> <ul> <li> <h3>Respuesta Correcta:</h3>' +
        '</li><li><textarea name="RespuestaCorrecta-' + num + '" id="RespuestaCorrecta-' + num + '" cols="30" rows="2"placeholder="Escriba la Respuesta Correcta"></textarea></li>' +
